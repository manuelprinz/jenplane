...
from jenplane_backend.adapters.output.mongodb.organizations import MongoOrganizationRepository
...
from jenplane_backend.adapters.output.mongodb.mongo_db import MongoDatabase, MongoConnectionProvider
...
def organization_repository(database: Database = Depends(mongo_database)):
